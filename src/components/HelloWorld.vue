<template>
    <div>
        ...
        <section id="content">
            ...
            <p id="text-learn-from">I learn everything from nature, and the internet.</p>

            <p id="traveling">
                There are no ways to learn from nature except traveling,
                <br />and luckily, that's exactly what I love.
            </p>
        ...
        <section id="photography">
            ...
            <div id="group">
                <img id="photo-a" src="../assets/images/8b6df735.jpg" />
                <img id="photo-b" src="../assets/images/f7e20fb5.jpg" />
                <img id="photo-c" src="../assets/images/dc4a72be.jpg" />
                <img id="photo-d" src="../assets/images/c76d0cd3.jpg" />
                <img id="photo-e" src="../assets/images/1739332d.jpg" />
                <img id="photo-f" src="../assets/images/99117f15.jpg" />
                <img id="photo-g" src="../assets/images/dd84e443.jpg" />
                <img id="photo-h" src="../assets/images/83b278df.jpg" />
            </div>
        </section>
        ...
        <section id="programming">
            <p>
                ...
                <br />I’m self-teaching programming via the internet.
            </p>
            ...
            <div id="nodes" onscroll="node.didScroll()">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="1920" height="800">
                    ...
                    <g fill="#404040">
                        <text>
                            <tspan x="226" y="459">Web</tspan>
                        </text>
                        <circle cx="212" cy="453" r="4" />
                        <text>
                            <tspan x="744" y="459">Artificial Intelligence</tspan>
                        </text>
                        ...
                        <text>
                            <tspan x="471" y="459">Server</tspan>
                        </text>
                        ...
                        <text>
                            <tspan x="1244" y="459">Internet of Things</tspan>
                        </text>
                        <circle cx="1230" cy="453" r="4" />
                        <text>
                            <tspan x="1574" y="459">Databases</tspan>
                        </text>
                        ...
                        <text>
                            <tspan x="807" y="379">Machine Learning</tspan>
                        </text>
                        ...
                        <text>
                            <tspan x="1508" y="370">Cache</tspan>
                        </text>
                        <circle cx="1494" cy="364" r="4" />
                        <text>
                            <tspan x="791" y="260">Image Classification</tspan>
                        </text>
                        <circle cx="777" cy="254" r="4" />
                        <text>
                            <tspan x="870" y="202">Image Recognition</tspan>
                        </text>
                        ...
                        <text>
                            <tspan x="1201" y="635">Raspberry Pi</tspan>
                        </text>
                        ...
                        <text>
                            <tspan x="1560" y="550">RDBMS</tspan>
                        </text>
                        ...
                        <text>
                            <tspan x="51" y="765">WeChat Mini Program</tspan>
                        </text>
                        ...
                        <text>
                            <tspan x="388" y="367">Containerization</tspan>
                        </text>
        ...
        <section id="design">
            <p id="text-design">
                ...
                <br />websites, visual identities, user experiences, and beyond.
            </p>
            <p id="text-dot-connecting">
                I’m connecting the dots to create cool things,
                <br />by combining everything I love.
            </p>
        </section>
        ...
        <section id="camarts" class="products">
            ...
            <div id="text-camarts" class="content">
                <p>
                    <img id="camarts-logo" src="../assets/images/camarts-logo.png" />
                </p>
                <p>
                    Camarts, a
            ...
            <div class="showcase">
                <div class="container">
                    <img
                        ...
                        srcset="https://v7.res.dandyweng.com/images/en/camarts-showcase-c@2x.png 2x"
                    />
                    <img
                        id="camarts-showcase-b"
                        src="../assets/images/en/camarts-showcase2.png"
                        srcset="https://v7.res.dandyweng.com/images/en/camarts-showcase-b@2x.png 2x"
                    />
                    <img
                        id="camarts-showcase-a"
                        src="../assets/images/en/camarts-showcase.png"
                        srcset="https://v7.res.dandyweng.com/images/en/camarts-showcase-a@2x.png 2x"
                    />
                </div>
            </div>
        </section>
        ...
        <section id="markly" class="products">
            ...
            <div class="showcase">
                <img
                    ...
                    srcset="https://v7.res.dandyweng.com/images/en/eyeye-showcase-a@2x.png 2x"
                />
                <img
                    id="markly-showcase-b"
                    src="../assets/images/en/eyeye-showcase-b.png"
                    srcset="https://v7.res.dandyweng.com/images/en/eyeye-showcase-b@2x.png 2x"
                />
            </div>
        </section>
        ...
        <section id="vary" class="products">
            ...
            <div class="showcase">
                <img
                    ...
                    srcset="https://v7.res.dandyweng.com/images/en/vary-showcase-c@2x.png 2x"
                />
                <img
                    id="vary-showcase-b"
                    src="../assets/images/en/vary-showcase-b.png"
                    srcset="https://v7.res.dandyweng.com/images/en/vary-showcase-b@2x.png 2x"
                />
                <img
                    id="vary-showcase-a"
                    src="../assets/images/en/vary-showcase-a.png"
                    srcset="https://v7.res.dandyweng.com/images/en/vary-showcase-a@2x.png 2x"
                />
            </div>
        </section>
                    ...
                    <div class="item-content">
                        ...
                        >
                            <img
                                ...
                                srcset="https://v7.res.dandyweng.com/images/en/talk@2x.jpg 2x"
                            />
                        </a>
                        <p>A talk I gave at Tongji University, Shanghai in December 2013.</p>
                        <p>
                            Watch on
                            <a
                                href="../www.youtube.com/watch9a19?v=F4BWNANyNhs"
                    ...
                    <div class="item-content">
                        <div id="new-message">
                            ...
                            <div id="step-2" class="inner-container">
                                ...
                                <button onclick="guestbook.post(this)">Save</button>
                            </div>
